...
export default function CertificatesPage() {
  ...
  const loadCertificates = async () => {
    ...
    try {
      ...
      const studentCerts = await getStudentCertificatesClient(
        userAddress.trim()
      );
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      {!loading && userAddress && certificates.length === 0 && !error && (
        <div className="text-center py-8 bg-gray-100 rounded-lg">
          <p className="text-gray-600">
            No se encontraron certificados para esta dirección.
          </p>
        </div>
      )}
      ...
      <div className="mt-12 bg-blue-50 rounded-lg p-6">
        ...
        <div className="text-sm text-blue-800 space-y-2">
          <p>
            • Los certificados están almacenados de forma permanente en el
            blockchain de Stacks
          </p>
          <p>
            • Cada certificado tiene un ID único y no puede ser modificado una
            vez emitido
          </p>
          <p>
            • Para consultar certificados, necesitas la dirección exacta de la
            billetera del estudiante
          </p>
          <p>
            • Los certificados pueden ser verificados por cualquier persona
